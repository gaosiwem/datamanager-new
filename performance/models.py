...
class Indicator(models.Model):
    ...
    annual_aggregate_output = models.TextField(
        blank=True)  # Preliminary_Summary2
    annual_pre_audit_output = models.TextField(
        blank=True)  # PrelimaryAudited_Summary2
    ...
    annual_audited_output = models.TextField(
        blank=True)  # ValidatedAuditedSummary2
    ...
    # class Meta:
    #     indexes = [
    #         # Define a normal index if necessary
    #         # Optional: for normal indexing
    #         models.Index(fields=['content_search']),
    #     ]
